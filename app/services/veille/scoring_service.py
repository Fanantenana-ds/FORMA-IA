...
def _score_domain(domain: str) -> int:
    """
    ✅ FIX: Alias pour tous les noms de domaines possibles.
    Groq retourne 'dev', 'ia', 'data', 'devops' mais le scoring
    ne connaissait que 'developpement'.
    """
    scores = {
        # IA
        "ia": 30,
    ...
    return scores.get(str(domain).lower().strip(), 5)  # ✅ Default 5 au lieu de 0
